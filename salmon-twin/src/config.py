...
DASHBOARD_SELECT_RAFT_MESSAGE = "Aceptar"
DASHBOARD_LIST_TITLE_RAFT = "Selecciona una balsa marina"
DASHBOARD_LIST_TITLE_ESTIMATOR = "Selecciona un estimador de precios"
DASHBOARD_LIST_ESTIMATOR_MESSAGE = "Aceptar"
DASHBOARD_SELECT_RAFT_ERORR_MESSAGE = "Debe seleccionar una balsa marina"
DASHBOARD_SELECT_ESTIMATOR_MESSAGE = "Si no se selecciona un estimador, se usará el predeterminado."
...
DASHBOARD_NO_TEMP_PERIOD_ERROR = "No se ha seleccionado un periodo de temperatura histórico."
DASHBOARD_TEMP_FILTER_ERROR = "Error al filtrar los datos de temperatura"
DASHBOARD_TEMP_FILTER_ERROR_MSG = "Error en filtrado de datos:{error}"
...
DASHBOARD_PREDICT_GET_ESTIMATORS_ERROR = "Error al obtener los estimadores de precio. {error}"
DASHBOARD_PREDICT_GET_ESTIMATORS = "No se encontraron estimadores de precios."
...
PRICEMODEL_TOP_ESTIMATORS_FILE = os.path.join(CONFIG_DIR, "estimators.json")
PRICEMODEL_ERROR_CREATE_FILE = "Error al crear el archivo {path} de configuración de estimadores: {e}"
PRICEMODEL_ERROR_LOAD_FILE = "Error al cargar el archivo {path} de configuración de estimadores: {e}"
PRICEMODEL_ERROR_SAVE_FILE = "Error al guardar el archivo {path} de configuración de estimadores: {e}"
...
PRICEMODEL_ERROR_SMOOTH_PRICE = "Error al suavizar los datos de precios: {e}"
PRICEMODEL_ERROR_NO_PRICE_DATA = "No hay datos de precios para el modelo"
